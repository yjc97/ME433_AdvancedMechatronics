...
int main() {
    ...
    while (1) {
        ...
        sprintf(m, "AdvancedMechatronics");
        ssd1306_drawMessage(0,0,m);
        sprintf(m, "heartbeat = %d", i);
        ssd1306_drawMessage(30,15 , m);
        sprintf(m, "fps = %0.2f", 24000000.0/time);
        ssd1306_drawMessage(30, 25, m);
        ssd1306_update();
